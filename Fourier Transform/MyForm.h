...
#pragma region Windows Form Designer generated code
			 ...
			 void InitializeComponent(void)
			 {
				 ...
				 this->loadImageToolStripMenuItem->Size = System::Drawing::Size(312, 26);
				 ...
				 this->setResultImageAsSourceImageToolStripMenuItem->Size = System::Drawing::Size(312, 26);
				 ...
				 this->methodToolStripMenuItem->Size = System::Drawing::Size(73, 24);
				 ...
				 this->fastFourierTransformToolStripMenuItem->Size = System::Drawing::Size(308, 26);
				 ...
				 this->lowpassFilterToolStripMenuItem->Size = System::Drawing::Size(308, 26);
				 ...
				 this->highpassFilterToolStripMenuItem->Size = System::Drawing::Size(308, 26);
				 ...
				 this->discreteFourierTransformToolStripMenuItem->Size = System::Drawing::Size(308, 26);
				 ...
				 this->inverseDiscreteFourierTransformToolStripMenuItem->Size = System::Drawing::Size(308, 26);
...
#pragma endregion
	...
	private: System::Void fastFourierTransformToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		fourierTransformMethod->FastFourierTransform(tmpImage, dataManager->GetOutputImage(), dataManager->GetFreqReal(), dataManager->GetFreqImag(), h);
	...
	private: System::Void lowpassFilterToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e)
	{
		...
		Bitmap^ LPImage = gcnew Bitmap(w, h);
		...
		for (int i = 0; i < h; i++)
		{
			for (int j = 0; j < w; j++)
			{
				...
				LPImage->SetPixel(j, i, Color::FromArgb(valuePixeli, valuePixeli, valuePixeli));
			}
		}
		pictureBox_OutputImage->Image = LPImage;
	}
	...
	private: System::Void highpassFilterToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e)
	{
		...
		Bitmap^ HPImage = gcnew Bitmap(w, h);
		...
		for (int i = 0; i < h; i++)
		{
			for (int j = 0; j < w; j++)
			{
				...
				HPImage->SetPixel(j, i, Color::FromArgb(valuePixeli, valuePixeli, valuePixeli));
			}
		}
	...
	private: System::Void inverseFastFourierTransformToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		fourierTransformMethod->InverseFastFourierTransform(tmpImage, dataManager->GetOutputImage(), dataManager->GetFreqReal(), dataManager->GetFreqImag(), h);
